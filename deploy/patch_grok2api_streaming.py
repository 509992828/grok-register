...
PATCHES = [
    ...
    PatchSpec(
        path=IMAGE_PATH,
        marker="Patched by grok-register: align app-chat image collect with modeId auto",
        label="align app-chat image collect with modeId auto",
        old="""            try:
                try:
        ...
        new="""            try:
                # Patched by grok-register: align app-chat image collect
                # with Grok's current modeId=auto routing.
                return await self._collect_app_chat(
                    token_mgr=token_mgr,
                    token=current_token,
    ...
    PatchSpec(
        path=IMAGE_PATH,
        marker="Patched by grok-register: use modeId auto for app-chat image stream",
        label="use modeId auto for app-chat image stream",
        ...
        new="""        overrides = self._app_chat_request_overrides(n, enable_nsfw)
    ...
    PatchSpec(
        path=IMAGE_PATH,
        marker="Patched by grok-register: use modeId auto for app-chat image collect",
        label="use modeId auto for app-chat image collect",
